 ...
 * class ini berfungsi untuk pengolahan database seperti onUpgrade() dan onCreate(), nama table,kolom dari extends SQLiteOpenHelper
 * ketika ingin menggunakan konstanta tersebut, kita tidak usah lagi menulis nama tabel berulang kali,
 * namun cukup dengan mengaksesnya dari kelas DBHelper.
 */
//deklarasi import package SQLite
